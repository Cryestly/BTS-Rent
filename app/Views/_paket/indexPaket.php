...
<div class="mb-3">
    <h1 class="text-3xl font-bold">Data Paket</h1>
    <div class="text-sm breadcrumbs">
        <ul>
            <li><a href="<?= base_url('user'); ?>" class="text-slate-400">Data Paket</a></li>
        </ul>
    </div>
</div>
<section>
                ...
                <tbody>
                    ...
                    foreach ($list_paket as $item) : ?>
                        <tr>
                                ...
                                <div class="flex items-center justify-center space-x-3">
                                    <div class="avatar">
                                        <div class="mask mask-squircle w-12 h-12">
                                            <img src="/uploads/<?= $item['photo_paket']; ?>" alt="" />
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td>
                                <a href="<?= base_url('paket/edit/') . $item['id_paket']; ?>" class="text-2xl hover:text-slate-400"><i class="fa-solid fa-pen-to-square hover:scale-110"></i></a>
                                <form action="<?= base_url('paket/' . $item['id_paket']); ?>" method="POST">
