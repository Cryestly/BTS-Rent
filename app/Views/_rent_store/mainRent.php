    ...
    <div class="container m-auto">
        <div class="flex justify-between items-center glass rounded-lg p-10 px-20">
            <div class="w-1/2 p-5">
                ...
                <p class="font-semibold text-xl">Selamat Datang di BTS RENT.</p>
                <h1>Destinasi utama Anda untuk pengalaman peminjaman pakaian yang tak terlupakan.
                    Kami adalah jasa penyewaan pakaian yang menghadirkan kemewahan dan gaya dalam genggaman Anda.
                    Dengan komitmen kami untuk memberikan layanan terbaik, BTS Rent menjadi pilihan ideal untuk semua kebutuhan berbusana Anda</h1>
...
<div class="mx-auto h-[93.25vh] flex bg-white ">
    <div class="container m-auto">
        ...
        <h1 class="text-2xl font-semibold text-center mb-10">Coming Soon</h1>
    </div>
</div>
...
<div class="mx-auto h-[93.25vh] flex bg-white ">
    <div class="container m-auto">
        ...
        <p class="w-1/3 text-center mx-auto mt-5">Memesan Busana untuk keperluan Seperti Acara Perpisahan Sekolah, Peernikahan, dan Lain-Lain!</p>
        <div class="mt-20">
            <h1 class="text-2xl font-semibold text-center mb-5">CERA KERJA</h1>
            <div class="flex justify-between w-1/3 mx-auto">
                <div class="grid w-20 ">
                    <i class="fa-solid fa-list-check text-6xl text-center"></i>
                    <p class="text-center mt-3">Pesan Busana</p>
                </div>
                <div class="grid w-20 ">
                    <i class="fa-solid fa-calendar-check text-6xl text-center"></i>
                    <p class="text-center mt-3">Atur Tanggal</p>
                ...
                <div class="grid w-20 ">
                    <i class="fa-solid fa-handshake text-6xl text-center"></i>
                    <p class="text-center mt-3">Proses Pembayaran</p>
                </div>
            </div>
            <p class="w-1/3 text-center mx-auto mt-5">Cek Busana yang ingin dipesan - Atur Pembayaran - Kunjingi toko untuk Mengambil Busana!!</p>
        </div>
    </div>
</div>
